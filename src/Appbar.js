...
export default function MyAppBar({ classes, handleSelectClassChange ,handleAddStudent }) {
    ...
    <div className={classesStyle.grow}>
      <AppBar position="static">
        <Toolbar>
          ...
          <Typography className={classesStyle.title} variant="h6" noWrap>
            Material-UI
          </Typography>
          ...
          <div className={classesStyle.sectionDesktop}>
            ...
            <IconButton aria-label="show 17 new notifications" color="inherit">
              <Badge badgeContent={countCountries} color="secondary">
                <EmojiFlagsIcon />
              </Badge>
            </IconButton> */}
            <IconButton 
